...
public class ProductoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btGuardar.setBackground(new java.awt.Color(255, 153, 153));
        btGuardar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btGuardar.setForeground(new java.awt.Color(51, 51, 51));
        btGuardar.setText("INGRESAR");
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        String noSerie = this.txtSerie.getText();
        int existencias = Integer.parseInt(this.txtExistencias.getText());
        String mensaje = controllerProducto.insertProducto(nombre, noSerie, existencias);
